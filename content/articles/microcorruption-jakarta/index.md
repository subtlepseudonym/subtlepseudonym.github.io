...
## Password protection
Password inputs appear to be truncated by 31 minus the length of the username. We can get around this by providing a maximum length username: 32 characters. In determining the password buffer length, 31 minus 32 overflows and allows us the maximum length of 511 (0x1ff).
